...
$(function () {
    ...
    var vMemberList = new Vue({
        ...
        methods: {
            ...
            createPrivateChat: function createPrivateChat(e) {
    ...
    var vPrivateChatList = new Vue({
        ...
        methods: {
            addItem: function addItem(n_item) {
                var isContain = false;
            ...
            isContain: function isContain(id) {
                var isContain = false;
                this.lists.map(function (item, index) {
    ...
    var vTodo = new Vue({
        ...
        methods: {
            ...
            delCompleted: function delCompleted() {
...
(function ($) {
    $.fn.extend({
        insertContent: function insertContent(myValue, t) {
            var $t = $(this)[0];
